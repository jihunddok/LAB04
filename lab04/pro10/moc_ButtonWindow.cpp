...
const QMetaObject ButtonWindow::staticMetaObject = {
    { &QMainWindow::staticMetaObject, qt_meta_stringdata_ButtonWindow.data,
      qt_meta_data_ButtonWindow,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *ButtonWindow::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ButtonWindow.stringdata0))
        return static_cast<void*>(const_cast< ButtonWindow*>(this));
